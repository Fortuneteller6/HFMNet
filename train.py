...
# model
from model.HFMNet import HFMNet
...
class Trainer(object):
    ...
    def testing (self, epoch):
        ...
        save_model(mean_IOU, self.best_IoU, self.save_dir, self.save_prefix, self.train_loss, test_loss, recall, precision, epoch, self.model.state_dict())
